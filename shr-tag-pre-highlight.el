...
;;
;; This package adds syntax highlighting support for code blocks in
...
;;
;; In the example above, I am using EWW to visit
;; https://emacs-china.org/t/eww/2949. The color theme is
...
;; Why is `eww-display-html' advised for Emacs versions older than 26?:
;;
...
;; (2015-12), but Emacs 25.2 (latest release - 2017-04) doesn't include
;; this commit.  Thus, if you want syntax highlighting in EWW, you have
;; to use the devel version of Emacs (also known as emacs-26 at this
;; moment) or advise `eww-display-html' as above.
